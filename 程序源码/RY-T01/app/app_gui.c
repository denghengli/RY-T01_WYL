...
const UI_STATE_TRANS UIStateArray[UI_STATE_ARR_MAX] =
{
    ...
    {CONFIG_MENU_ONE_SELECT_2,  CONFIG_MENU_ONE_SELECT_1, CONFIG_MENU_ONE_SELECT_3,  CONFIG_MENU_ONE_SELECT_2,  HANDLE_BLOW_ENTER,  MAIN_WIND},
    {CONFIG_MENU_ONE_SELECT_3,  CONFIG_MENU_ONE_SELECT_2, CONFIG_MENU_ONE_SELECT_4,  CONFIG_MENU_ONE_SELECT_3,  FLOW_ADJUST_ENTER,  MAIN_WIND},
