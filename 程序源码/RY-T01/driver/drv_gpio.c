...
const  struct DRV_Pin   DRV_PINS[] =
{
    ...
    {epin_GAS_SDA2,     LL_APB2_GRP1_PERIPH_GPIOB, GPIOB, LL_GPIO_PIN_8,  PIN_HIGH},
    {epin_GAS_SCL2,     LL_APB2_GRP1_PERIPH_GPIOB, GPIOB, LL_GPIO_PIN_9,  PIN_HIGH},
    ...
    {epin_KEY0,         LL_APB2_GRP1_PERIPH_GPIOB, GPIOB, LL_GPIO_PIN_12,  PIN_LOW},
    {epin_KEY1,         LL_APB2_GRP1_PERIPH_GPIOC, GPIOC, LL_GPIO_PIN_10,  PIN_LOW},
    {epin_KEY2,         LL_APB2_GRP1_PERIPH_GPIOC, GPIOC, LL_GPIO_PIN_11,  PIN_LOW},
    {epin_KEY3,         LL_APB2_GRP1_PERIPH_GPIOC, GPIOC, LL_GPIO_PIN_12,  PIN_LOW},
    {epin_KEY4,         LL_APB2_GRP1_PERIPH_GPIOC, GPIOC, LL_GPIO_PIN_3,   PIN_LOW},
    ...
    {epin_VALVE3,       LL_APB2_GRP1_PERIPH_GPIOC, GPIOC, LL_GPIO_PIN_4,  PIN_LOW},
    {epin_VALVE4,       LL_APB2_GRP1_PERIPH_GPIOC, GPIOC, LL_GPIO_PIN_5,  PIN_LOW},

    {epin_RUN,          LL_APB2_GRP1_PERIPH_GPIOC, GPIOC, LL_GPIO_PIN_0,  PIN_LOW},
    {epin_WDT,          LL_APB2_GRP1_PERIPH_GPIOA, GPIOA, LL_GPIO_PIN_8,  PIN_LOW},
    {epin_LCD_BLK,      LL_APB2_GRP1_PERIPH_GPIOA, GPIOA, LL_GPIO_PIN_12,  PIN_LOW}
};
