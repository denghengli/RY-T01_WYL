...
Gui_StrCenter(0,lcddev.height-18,"思迈微版权所有 ",WHITE,BLUE,16,1);//居中显示
//绘制测试区域
...
void main_test(void)
{
	...
	Gui_StrCenter(0,30,"思迈微电子",RED,BLUE,16,1);//居中显示
	Gui_StrCenter(0,60,"综合测试程序",RED,BLUE,16,1);//居中显示	
	Gui_StrCenter(0,90,"ILI9341 240X320",RED,BLUE,16,1);//居中显示
	Gui_StrCenter(0,120,"思迈微电子 2020-05-05",RED,BLUE,16,1);//居中显示
	delay_ms(1000);		
	delay_ms(1000);
}
...
{	
	...
	Show_Str(10,30,"16X16:思迈微电子有限公司欢迎您",BLUE,YELLOW,16,0);
	Show_Str(10,50,"16X16:Welcome思迈微",BLUE,YELLOW,16,1);
	Show_Str(10,70,"24X24:Welcome思迈微",BLUE,YELLOW,24,1);
	Show_Str(10,100,"32X32:Welcome思迈微",BLUE,YELLOW,32,1);
	delay_ms(1200);
}
